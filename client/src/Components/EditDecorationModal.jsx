...
const EditDecorationModal = ({ open, onClose, onSubmit, initialValues }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-8 relative max-h-[90vh] overflow-y-auto">
        ...
        <h2 className="text-2xl font-bold mb-6 text-marriageHotPink">Edit Decoration Package</h2>
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <Button btnText="Update Decoration Package" btnColor="marriageHotPink" padding="w-full py-3" type="submit" />
        </form>
      </div>
    </div>
  );
