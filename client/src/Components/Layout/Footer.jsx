...
export const Footer = () => (
  <footer className="bg-[#0a1333] text-white pt-12 pb-4 px-4 mt-16">
    <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between gap-10 md:gap-0">
      ...
      {/* Center: Terms */}
      <div className="flex-1 min-w-[180px] mt-8 md:mt-0">
      ...
      {/* Right: Contact */}
      <div className="flex-1 min-w-[220px] mt-8 md:mt-0">
    ...
    {/* Bottom bar */}
    <div className="border-t border-gray-700 mt-10 pt-4 flex flex-col md:flex-row items-center justify-between max-w-6xl mx-auto text-xs text-gray-400">
      <div className="mb-2 md:mb-0">© OnlineNikah 2023 - All Rights Reserved</div>
      <div className="flex gap-6">
        <a href="#" className="hover:text-marriageHotPink font-mono tracking-wider
">FACEBOOK</a>
        <a href="#" className="hover:text-marriageHotPink font-mono tracking-wider
">TWITTER</a>
        <a href="#" className="hover:text-marriageHotPink font-mono tracking-wider
